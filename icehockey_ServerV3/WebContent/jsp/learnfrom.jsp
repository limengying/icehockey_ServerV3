<%@page
	import="com.icehockey.entity.CoachPlayer,java.util.List,com.icehockey.service.CoachPlayerService,org.codehaus.jackson.map.ObjectMapper,java.util.HashMap,java.util.Map,com.icehockey.entity.User,com.icehockey.service.UserService,java.io.PrintWriter"%>
...
<%
	...
	if (user != null) {//插入成功
		List<CoachPlayer> coachPlayers = coachPlayerService
				.queryCoachPlayerRecordByUserId("player", userId);
